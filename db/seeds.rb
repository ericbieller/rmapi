...
# insert into country_zones (created_at, updated_at, name, code, country_id) values (current_timestamp, current_timestamp, '', '02', '319');
# update country_zones set parcel_force_zone = '4';